                                ...
                                <td>
                                    <div class="row">
                                        <div class="center-block">
                                            <a href="#" class="btn btn-success btn-circle mx-1"><i class="fa fa-pencil"
                                                    aria-hidden="true"></i></a>
                                        </div>
                                        <div class="center-block">
                                            <a href="#" class="btn btn-warning btn-circle mx-1"><i class="fa fa-eye"
                                                    aria-hidden="true"></i></a>
                                        </div>
                                        <div class="center-block">

                                            <form action="">
                                                <button type="submit" class="btn btn-danger btn-circle mx-1"><i
                                                        class="fa fa-window-close-o" aria-hidden="true"></i></button>
                                            </form>
                                        </div>
                                    </div>
